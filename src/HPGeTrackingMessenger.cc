...
HPGeTrackingMessenger::HPGeTrackingMessenger(HPGeTrackingAction* tracking)
:Action(tracking)
{
...
HPGeTrackingMessenger::~HPGeTrackingMessenger()
{
...
void HPGeTrackingMessenger::SetNewValue(G4UIcommand* command,
                                               G4String newValue)
{ 
